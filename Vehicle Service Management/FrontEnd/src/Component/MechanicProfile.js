  ...
  return (
    <div>
      ...
      <div className="row" style={{ margin: "15px 600px" }}>
        ...
        <div>
          <h3 style={{ textAlign: "center", color: "orange" }}>Mechanic Profile</h3><br></br>
          <div className="col">
            <table style={{ width: "25rem", marginLeft: "50px", color: "#884EA0" }} >
              <tr  ><td><h5>First Name: </h5></td><td>< h5 >{mechanic.firstName}</h5></td><br></br></tr>
              <tr  ><td><h5>Last Name: </h5></td><td>< h5 >{mechanic.lastName}</h5></td><br></br></tr>
              <tr  ><td><h5>Email ID: </h5></td><td>< h5 >{mechanic.emailId}</h5></td><br></br></tr>
              <tr  ><td><h5>Mobile No: </h5></td><td>< h5>{mechanic.mobileNo}</h5></td><br></br></tr>
              <tr  ><td><h5>Address </h5></td><td>< h5 >{mechanic.address}</h5></td><br></br></tr>
              <tr  ><td><h5>Skills </h5></td><td>< h5 >{mechanic.skills}</h5></td><br></br></tr>
              <tr><td><b> <button
