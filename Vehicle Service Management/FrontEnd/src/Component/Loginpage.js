...
export default function Loginpage() {
  ...
  return (
    <div>
      ...
      <Container className="row" style={{ margin: "100px 400px" }}>
        ...
        <Card className="card bg-info" style={{ width: "40rem" }}>
          <Card.Body>
            ...
            <Card.Text>
              <Form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Button variant="none" type="submit" className=" btn m-2 btn-outline-success text-dark">
                  Login
                </Button>

                <button
                  className="btn btn-outline-danger text-dark m-2"
                  onClick={() => {
                    navigate("/Home");
                  }}
                >
